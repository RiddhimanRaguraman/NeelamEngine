...
namespace NeelamEditor.Utilities.Controls
{
    ...
    // Groups up to four NumberBoxes (X/Y/Z/W) into one field. VectorType hides the
    // unused axes; Orientation lays them in a row or a column. Each axis binds to a
    // string so a mixed multi-selection can show blank per-axis.
