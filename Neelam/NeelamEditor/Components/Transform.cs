...
namespace NeelamEditor.Components
{
    ...
    // Multi-selection editor for Transform. Each axis is a float? so a mixed
    // selection reads back as null (blank in the inspector). Writing one axis
    // preserves the others per-entity via the `?? c.Position.X` fallbacks.
    sealed class MSTransform : MSComponent<Transform>
    {
        ...
        {
            get => _posX;
            set { if (!_posX.IsTheSameAs(value)) { _posX = value; OnPropertyChanged(nameof(PosX)); } }
        }
        ...
        {
            get => _posY;
            set { if (!_posY.IsTheSameAs(value)) { _posY = value; OnPropertyChanged(nameof(PosY)); } }
        }
        ...
        {
            get => _posZ;
            set { if (!_posZ.IsTheSameAs(value)) { _posZ = value; OnPropertyChanged(nameof(PosZ)); } }
        }
        ...
        {
            get => _rotX;
            set { if (!_rotX.IsTheSameAs(value)) { _rotX = value; OnPropertyChanged(nameof(RotX)); } }
        }
        ...
        {
            get => _rotY;
            set { if (!_rotY.IsTheSameAs(value)) { _rotY = value; OnPropertyChanged(nameof(RotY)); } }
        }
        ...
        {
            get => _rotZ;
            set { if (!_rotZ.IsTheSameAs(value)) { _rotZ = value; OnPropertyChanged(nameof(RotZ)); } }
        }
        ...
        {
            get => _scaleX;
            set { if (!_scaleX.IsTheSameAs(value)) { _scaleX = value; OnPropertyChanged(nameof(ScaleX)); } }
        }
        ...
        {
            get => _scaleY;
            set { if (!_scaleY.IsTheSameAs(value)) { _scaleY = value; OnPropertyChanged(nameof(ScaleY)); } }
        }
        ...
        {
            get => _scaleZ;
            set { if (!_scaleZ.IsTheSameAs(value)) { _scaleZ = value; OnPropertyChanged(nameof(ScaleZ)); } }
        }
