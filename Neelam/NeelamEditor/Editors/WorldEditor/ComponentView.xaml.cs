...
{
    // Framed section for one component. ComponentContent is the ContentProperty, so
    // a component view writes its fields directly between the <local:ComponentView>
    // tags and they land in the expander body.
